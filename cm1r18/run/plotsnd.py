...
# Debug code....
    ...
    def write(self, filename=None, sharpPY=None, InitCM1=False, sheader=None):
...
if __name__ == "__main__":
    ...
    parser.add_option( "--initcm1",   dest="initcm1",  action="store_true", help="Boolean flag to write out sounding file with zero winds")
...
#     Ngl.end()
      ...
      if options.initcm1:
        commasfile = options.file.split("pfs")[0] + "cm1Init"
        a.write(filename=commasfile, InitCM1=True)
