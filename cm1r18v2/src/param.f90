...
!-----------------------------------------------------------------------
      ...
      namelist /param9/                                                       &
              ...
              restart_format,restart_filetype,output_interp,                  &
...
!  begin non-fatal checks:
      ...
      IF( restart_filetype.ne.1 )THEN
        if(myid.eq.0)then
        print *,'  -------------------------------- '
        print *
        print *,'  Single processor run: '
        print *
        print *,'  ... setting restart_filetype to 1 ... '
        print *
        print *,'  -------------------------------- '
        endif
        restart_filetype = 1
      ...
      IF( restart_format.eq.2 .and. restart_filetype.ne.1 )THEN
        if(myid.eq.0)then
        print *,'  -------------------------------- '
        print *
...
!  Begin hard-wired analytic stretching function
      ...
      IF(stretch_x.eq.1)THEN
        ...
        if(dowr) write(outfile,*)
!
!       ni1 = nint( (tot_x_len-nos_x_len) / (dx_inner + dx_outer))
!       dx_outer = (tot_x_len-nos_x_len) / float(ni1) - dx_inner
!
